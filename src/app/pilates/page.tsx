...
export default function PilatesLanding() {
  return (
    <div className="min-h-screen bg-[#FAF8F5]">
      ...
      {/* CTA Banner */}
      <div className="fixed top-[73px] left-0 right-0 z-40 bg-gradient-to-r from-[#E8B4B8]/90 via-[#9BA899]/90 to-[#B8AFA5]/90 backdrop-blur-sm border-b border-white/20">
        <div className="container mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <Link href="/pilates/schedule">
            <Button size="sm" className="bg-white text-[#5A5550] hover:bg-white/90 rounded-full font-semibold">
              Book Now
            </Button>
          </Link>
        </div>
      ...
      {/* Hero Section */}
      <section className="relative pt-[140px] pb-24 md:pt-[160px] md:pb-32 overflow-hidden bg-gradient-to-b from-[#F5F2EE] to-[#FAF8F5]">
